...
class BabylonScene extends Component {
  ...
  addGround = () => {
    ...
    var ceilingMaterial = new BABYLON.StandardMaterial("ceilingMaterial", scene);
        ceilingMaterial.ambientTexture = new BABYLON.Texture("./assets/images/V2images/metal2.jpg", scene);
    var floorMaterial = new BABYLON.StandardMaterial("floorMaterial", scene);
        floorMaterial.ambientTexture = new BABYLON.Texture("./assets/images/V2images/27.jpg", scene);
    var boxMaterial = new BABYLON.StandardMaterial("boxMaterial", scene);
        boxMaterial.ambientTexture = new BABYLON.Texture("./assets/images/V2images/112.jpg", scene);
    var cubeMaterial = new BABYLON.StandardMaterial("cubeMaterial", scene);
        cubeMaterial.ambientTexture = new BABYLON.Texture("./assets/images/V2images/concrete4.jpg", scene);
    var columnTrimMaterial = new BABYLON.StandardMaterial("columnTrimMaterial", scene);
        columnTrimMaterial.ambientTexture = new BABYLON.Texture("./assets/images/V2images/yb.jpg");
    var pictureimg = new BABYLON.StandardMaterial("pictureimg", scene);
        pictureimg.ambientTexture = new BABYLON.Texture("./assets/images/V2images/5.jpg")
    var picture2img = new BABYLON.StandardMaterial("picture2img", scene);
        picture2img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/ss11.png");
    var picture3img = new BABYLON.StandardMaterial("picture3img", scene);
        picture3img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/125.png");
    var picture4img = new BABYLON.StandardMaterial("picture4img", scene);
        picture4img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/107.png");
    var picture5img = new BABYLON.StandardMaterial("picture5img", scene);
        picture5img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/6.jpg");
    var picture6img = new BABYLON.StandardMaterial("picture6img", scene);
        picture6img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/blood.jpg");
    var picture7img = new BABYLON.StandardMaterial("picture7img", scene);
        picture7img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/city3.jpg");
    var picture8img = new BABYLON.StandardMaterial("picture8img", scene);
        picture8img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/73.jpg");
    var picture9img = new BABYLON.StandardMaterial("picture9img", scene);
        picture9img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/131.png");
    var picture10img = new BABYLON.StandardMaterial("picture10img", scene);
        picture10img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/124.png");
    var picture11img = new BABYLON.StandardMaterial("picture11img", scene);
        picture11img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/123.png");
    var picture12img = new BABYLON.StandardMaterial("picture12img", scene);
        picture12img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/127.png");
    var picture13img = new BABYLON.StandardMaterial("picture13img", scene);
        picture13img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/119.png");
    var picture14img = new BABYLON.StandardMaterial("picture14img", scene);
        picture14img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/118.png");
    var picture15img = new BABYLON.StandardMaterial("picture15img", scene);
        picture15img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/126.png");
    var picture16img = new BABYLON.StandardMaterial("picture15img", scene);
        picture16img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/logoline.jpg");

    var picture17img = new BABYLON.StandardMaterial("picture17img", scene);
        picture17img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h22.jpg");
    var picture18img = new BABYLON.StandardMaterial("picture18img", scene);
        picture18img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h16.png");
    var picture19img = new BABYLON.StandardMaterial("picture19img", scene);
        picture19img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h12.png");
    var picture20img = new BABYLON.StandardMaterial("picture20img", scene);
        picture20img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h20.png");
    var picture21img = new BABYLON.StandardMaterial("picture21img", scene);
        picture21img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h12.png");
    var picture22img = new BABYLON.StandardMaterial("picture22img", scene);
        picture22img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/h35.jpg");
    var picture23img = new BABYLON.StandardMaterial("picture23img", scene);
        picture23img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/album1.3.jpg");
    var picture24img = new BABYLON.StandardMaterial("picture24img", scene);
        picture24img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/60.jpg");
    var picture25img = new BABYLON.StandardMaterial("picture25img", scene);
        picture25img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/comp3.jpg");
    var picture28img = new BABYLON.StandardMaterial("picture28img", scene);
        picture28img.ambientTexture = new BABYLON.Texture("./assets/images/V2images/grade.png");
